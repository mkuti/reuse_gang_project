    ...
    cardHtml = `
			...
			<div class="card my-2 text-center">
				<div class="card-body p-0">
                    <div class="row my-3">
                        <div class="col px-0">
                            <h4 class="card-title text-uppercase mb-4" id="item_name">${item.item_name}</h4>
					        <h5 class="card-subtitle mb-4" id="item_category">Category: ${item.item_category}</h5>
                            <h5 class="card-subtitle mb-2" id="item_username">Left by: Username</h5>
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col">
