...
* [UX](#ux)
    * [Strategy: Why and what?](#why-and-what)
        ...
        * [6. Research](#5-research)
        * [7. Planning](#5-planning)
        * [User Stories](#user-stories)
    * [Scope plane: How?](#how)
    * [Structure plane: Organisation and functionality](#organisation-and-functionality)
        * [1.Existing Features](#1-existing-features)
        * [2.Features Left to Implement](#2-features-left-to-implement)
    * [Skeleton plane: Presentation and navigation](#presentation-and-navigation)
